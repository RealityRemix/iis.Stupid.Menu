    ...
    public static class Buttons
    {
        public static ButtonInfo[][] buttons =
        {
            ...
            new[] { // Menu Settings [2]
                ...
                new ButtonInfo { buttonText = "Disable Menu Title", enableMethod =() => { if (pageButtonType == 1) buttonOffset = 1; else buttonOffset = -1; hidetitle = true; }, method =() => { if (pageButtonType == 1) buttonOffset = 1; else buttonOffset = -1; hidetitle = true; }, disableMethod =() => { buttonOffset = pageButtonType == 1 ? 2 : 0; hidetitle = false; }, toolTip = "Hides the menu title, allowing for more buttons per page."},
            ...
            new[] { // Fun Mods [12]
                ...
                new ButtonInfo { buttonText = "Ranged Enemy Spam <color=grey>[</color><color=green>G</color><color=grey>]</color>", method =() => Overpowered.SpamObjectGrip(Overpowered.ObjectByName["GhostReactorEnemyRangedArmored"]), toolTip = "Spawns ranged enemies out of your hand when holding <color=green>grip</color>."},
                new ButtonInfo { buttonText = "Chaser Enemy Spam <color=grey>[</color><color=green>G</color><color=grey>]</color>", method =() => Overpowered.SpamObjectGrip(Overpowered.ObjectByName["GhostReactorEnemyChaserArmored"]), toolTip = "Spawns chasing enemies out of your hand when holding <color=green>grip</color>."},
            ...
            new[] { // Master Mods [16]
                ...
                new ButtonInfo { buttonText = "Set Quota", method = Fun.SetQuota, toolTip = "Meets the quota fora you."},
            ...
            new[] { // Credits [38]
                ...
                new ButtonInfo { buttonText = "Kingofnetflix", method =() => Process.Start("https://github.com/kingofnetflix"), isTogglable = false, toolTip = "Kingofnetflix is a developer of ii's <b>Stupid</b> Menu. Creating mods since 2022, he's been very impactful towards this menu."},
